...
class Products extends Admin_Controller 
{
    ...
    */
	public function fetchProductData()
	{
		...
		foreach ($data as $key => $value) {
			...
			$img = '<img src="'.base_url($value['image']).'" alt="'.$value['name'].'" class="img-circle" width="100" height="100" />';
    ...
    */
	public function create()
	{
        ...
        $this->form_validation->set_rules('is_veg', 'Is it Veg', 'trim|required');
        $this->form_validation->set_rules('is_healthy', 'Is it Healthy', 'trim|required');
        $this->form_validation->set_rules('is_tax_inclusive', 'Is it Tax Inclusive', 'trim|required');
		$this->form_validation->set_rules('active', 'Active', 'trim|required');
		
	
        if ($this->form_validation->run() == TRUE) {
            // true case
            // die(var_dump($this->input->post('size')));
        	...
        	$data = array(
                ...
                'size_id' => json_encode((int)$this->input->post('size')),
                'store_id' => json_encode($this->input->post('store')),
                'is_veg' => json_encode($this->input->post('is_veg')),
                'is_healthy' => json_encode($this->input->post('is_healthy')),
                'is_tax_inclusive' => json_encode($this->input->post('is_tax_inclusive')),
            ...
            $this->data['sizes'] = $this->model_products->getProductSize();          	

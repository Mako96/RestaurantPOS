        ...
        <div class="col-md-12 col-xs-12">
          <form class="form-inline" action="<?php echo base_url('reports/storewise') ?>" method="POST">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="select_payment_type" id="select_payment_type">
                <option value="">Select Payment Type</option>
                <?php foreach ($payment_type as $key => $value): ?>
                  <option value="<?php echo $value['id'] ?>" <?php if($selected_payment_type == $value['id']) { echo 'selected="selected"'; } ?>><?php echo $value['name']; ?></option>
                <?php endforeach ?>
              </select>
            </div>

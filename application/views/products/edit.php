          ...
          <form role="form" action="" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="length" name="length" placeholder="Enter Length" autocomplete="off" value="<?php echo !empty($this->input->post('length')) ?:$product_data['length'] ?>"/>
                </div>
                <div class="form-group">
                  <label for="diameter">Diameter</label>
                  <input type="text" class="form-control" id="diameter" name="diameter" placeholder="Enter Diameter" autocomplete="off" value="<?php echo !empty($this->input->post('diameter')) ?:$product_data['diameter'] ?>"/>
                </div>
                <div class="form-group">
                  <label for="measure_unit">Unit of Measurement</label>
                  <input type="text" class="form-control" id="measure_unit" name="measure_unit" placeholder="Enter Unit of Measurement" autocomplete="off" value="<?php echo !empty($this->input->post('measure_unit')) ?:$product_data['measure_unit']?>"/>
                </div>
                ...
                <div class="form-group">
                  <label for="is_veg">Is it Veg?</label>
                  <select class="form-control select_group" id="is_veg" name="is_veg">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select_group" id="is_healthy" name="is_healthy">
                      <option value="0">No</option> 
                      <option value="1">Yes</option> 
                  </select>
                </div>
                <div class="form-group">
                  <label for="is_tax_inclusive">Is Price Tax Inclusive?</label>
                  <select class="form-control select_group" id="is_tax_inclusive" name="is_tax_inclusive">
                    <option value="0">No</option>
                    <option value="1">Yes</option>
                  </select>
                </div>
